           ...
           echo " <table class='table table-bordered'>";
            ...
            echo "<div >";
                  ...
                  while($row = $result->fetch_assoc()) 
              {
                if($row['year']==1)
                {
                  $m1=$m1+$row['credit']*$row['external'];
                  $c1+=$row['credit'];
                }
                if($row['year']==2)
                {
                  $m2=$m2+$row['credit']*$row['external'];
                  $c2+=$row['credit'];
                }
                if($row['year']==3)
                {
                  $m3=$m3+$row['credit']*$row['external'];
                  $c3+=$row['credit'];
                }
                if($row['year']==4)
                {
                  $m4=$m4+$row['credit']*$row['external'];
                  $c4+=$row['credit'];
                }
                if($row['year']==5)
                {
                  $m5=$m5+$row['credit']*$row['external'];
                  $c5+=$row['credit'];
                }
                if($row['year']==6)
                {
                  $m6=$m6+$row['credit']*$row['external'];
                  $c6+=$row['credit'];
                }
                if($row['year']==7)
                {
                  $m7=$m7+$row['credit']*$row['external'];
                  $c7+=$row['credit'];
                }
                if($row['year']==8)
                {
                  ...
                  echo "<td>".$m1/($c1)."</td>"."<td>".$m2/($c2)."</td>"."<td>".$m3/($c3)."</td>"."<td>".$m4/($c4)."</td>"."<td>".$m5/($c5)."</td>"."<td>".$m6/($c6)."</td>"."<td>".$m7/($c7)."</td>"."<td>".$m8/($c8)."</td>";
                  echo "</tr>";
                   echo "</table>";
                   echo "</div>";
                   echo "<br>";
