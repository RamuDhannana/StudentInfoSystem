...
<html lang="en">
  ...
  <body>
    ...
    <div class='menu' style="margin-left: 700px;margin-top:-30px;">

        <ul>
        <li><a href='teachersearch.php'>Search Student</a></li>
         <li><a href='aboutus.html'>About</a></li>
         <li><a href='dailyattendance.php'>Take Today Attendance</a></li>
